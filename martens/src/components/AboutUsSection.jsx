                ...
                <Container>
                    <Grid2 container spacing={5}>
                        ...
                        <Grid2 xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <Typography component="h1" variant="h3" color="initial" sx={{ paddingBottom: '1rem' }}> Quiénes somos</Typography>
                            <Typography variant="body1" color="initial" sx={{ paddingBottom: { xs: '2rem', md: '0rem' }, textAlign: 'justify' }}>Bienvenidos a, una empresa familiar con más de 30 años de experiencia en la ciudad de Tandil.
